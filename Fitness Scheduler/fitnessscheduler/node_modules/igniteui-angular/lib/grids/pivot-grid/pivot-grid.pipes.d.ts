...
import { IPivotConfiguration, IPivotDimension, IPivotGridColumn, IPivotGridGroupRecord, IPivotGridRecord, IPivotValue } from './pivot-grid.interface';
...
export declare class IgxPivotGridCellStyleClassesPipe implements PipeTransform {
    ...
    static ɵfac: i0.ɵɵFactoryDeclaration<IgxPivotGridCellStyleClassesPipe, never>;
    static ɵpipe: i0.ɵɵPipeDeclaration<IgxPivotGridCellStyleClassesPipe, "igxPivotCellStyleClasses">;
}
export {};
